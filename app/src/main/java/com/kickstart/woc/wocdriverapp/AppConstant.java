...
public class AppConstant {
    ...
    //aws details
    public static final  String AWS_ACCESS_KEY = "AKIAW4RE336ZH4CQC4MJ";
    public static final  String AWS_SECRET_KEY = "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";
    public static final  String AWS_IMAGES_BUCKET_NAME = "wocdriverbimagebucket";
    public static final  String AWS_IMAGES_BUCKET_NAME_TEST = "woctest";
    ...
    public static final String PREF_KEY_MOBILE = "WOCDriverMobile";
    public static final String PREF_KEY_DRIVER_DETAILS = "WOCDriverDetails";
    public static final String PREF_KEY_PIN = "WOCDriverPin";
    public static final String PREF_KEY_DEVICE_ID = "WOCDriverDeviceId";
