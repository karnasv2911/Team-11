...
public class AppFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(Bundle bundle) {
        ...
        woCPushNotificationsUtil = new WoCPushNotificationsUtil(this);
        woCPushNotificationsUtil.configureNotificationActions(bundle);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel mChannel = new NotificationChannel("wocdriverapp", "wocdriverapp", NotificationManager.IMPORTANCE_HIGH);
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this, "wocdriverapp");
