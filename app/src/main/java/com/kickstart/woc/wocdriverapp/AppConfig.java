...
public class AppConfig {
    ...
    private static final String DEFAULT_LOG_TAG = "WOCRiderApp";
    private static final String SHARED_PREF_NAME = "WOCRiderPref";
    private static final String BASE_FOLDER_NAME = "WOCRider";
    public static final String DATABASE_NAME = "WOCRiderDB";
